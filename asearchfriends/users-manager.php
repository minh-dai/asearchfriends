                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Quản Lý Người Dùng</li>
                                        </ul>
                                    </div>
                                    <a href="them.php"><button class="au-btn au-btn-icon au-btn--green" >
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        ...
                                                        <a href="sua.php?id=<?php echo($value['user_id']) ?>">
                                                        <button class="item" data-toggle="tooltip" data-placement="top"
                                                            title="Edit">
                                                            <i class="zmdi zmdi-edit"></i>
                                                        </button>
                                                        </a>
                                                       <button onsubmit="return xacnhanxoa()" class="item" data-toggle="tooltip" data-placement="top" name="xoa" 
                                                            title="Delete"><a href="xoa_user.php?id=<?php echo($value['user_id']) ?>"
                                                       	>
