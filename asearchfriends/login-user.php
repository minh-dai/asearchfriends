...
if (isset($_POST["submit"])) {
    ...
    if ($password == "" || $email == "" || $remember == NULL) {
        ...
        if (mysqli_num_rows($kt) > 0) {
            ...
            while ($row = mysqli_fetch_array($kt)) {
                ...
                $_SESSION["user_old"] = $row["user_old"];
            ...
            echo "Email không tồn tại hoặc mật khẩu sai !";
        }
    }
}
?>
                            ...
                            <div class="login-form">
                                <form action="login-user.php" method="post">
                                    ...
                                    <div class="login-checkbox">
                                        ...
                                        <label>
                                            <u><a href="forget-pass.php">Quên mật khẩu?</a></u>
                                        </label>
                                    </div>
                                ...
                                <div class="register-link">
                                    <p>
                                        Bạn đã có tài khoản?
                                        <u><a href="register.php">Đăng ký</a></u>
                                    </p>
                                </div>
                            </div>
                        </div>
