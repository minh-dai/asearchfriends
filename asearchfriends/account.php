                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">
                                <h3 class="text-center title-2">Thông Tin cá nhân</h3>
                            </div>
                            <hr>
                            <form action="" method="post" novalidate="novalidate">
                                ...
                                <div class="form-group">
                                    ...
                                    <img style="margin-left: 20px;"src="<?php echo $_SESSION["user_image"]; ?>" />
                                </div>
                                <div class="form-group">
                                    <label for="cc-payment" class="control-label mb-1">ID</label>
                                    <input disabled class="form-control" style="width: 20%;" value="<?php echo $_SESSION["user_id"]; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="cc-payment" class="control-label mb-1">Tên hiển thị</label>
                                    <input disabled class="form-control" style="width: 30%;" value="<?php echo $_SESSION["user_name"]; ?>">
                                </div>
                                ...
                                <div class="form-group has-success">
                                    ...
                                    <input disabled class="form-control" style="width: 10%;" value="<?php echo $_SESSION["user_old"]; ?>">
                                   
                                </div>
                                <div class="form-group has-success">
                                    <label for="cc-name" class="control-label mb-1">Số điện thoại</label>
                                    <input disabled class="form-control" style="width: 20%;" value="<?php echo $_SESSION["user_phone"]; ?>">
                                   
                                </div>
                                <div class="form-group has-success">
                                    <label for="cc-name" class="control-label mb-1">Giới Tính</label>
                                    <input disabled class="form-control" style="width: 10%;" value="<?php echo $_SESSION["user_sex"]; ?>">
                                   
                                </div>
                                <div class="form-group has-success">
                                    <label for="cc-name" class="control-label mb-1">Địa Chỉ</label>
                                    <input disabled class="form-control" style="width: 60%;" value="<?php echo $_SESSION["user_address"]; ?>">
